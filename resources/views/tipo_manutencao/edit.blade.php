...
@section('content')
    ...
    <form action="" id="cadastro-tipo_manutencao" nome="cadastro-tipo_manutencao" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/tipo_manutencao/edit/{{$tipo_manutencoes->id}}">
        ...
        <div class="row">
            <div class="form-group col-md-5">
                Tipo da Manutenção:
                <input class="form-control" type="text" name="tipo" id="tipo" value="{{$tipo_manutencoes->tipo}}" >
            </div>
        </div>
