...
@section('content')
    ...
    @if ($errors->any())
        ...
        <br/>
    @endif
    <h3 class=""><i class="fas fa-gas-pump"></i></i> Comboios</h3>
    <form action="" id="cadastro-comboio" nome="cadastro-comboio" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/comboio/store">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                Tanque/Comboio:
                <input class="form-control" type="text" name="tanque" id="tanque"  value="" >
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('button#sair').click(function(){
                $(location).attr('href',url+'/comboio');
            })
