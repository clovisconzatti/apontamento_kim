...
@section('content')
    ...
    @if ($errors->any())
        ...
        <br/>
    @endif
    <h3 class=""><i class="fas fa-snowplow"></i> Tipo de Veiculos</h3>
    <form action="" id="cadastro-tipo" nome="cadastro-tipo" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/tipo/edit/{{$tipo->id}}">
        ...
        <div class="row">
            <div class="form-group col-md-6">
                Tipo de Veiculo:
                <input class="form-control" type="text" name="tipo" id="tipo" value="{{$tipo->tipo}}" >
            </div>
        </div>
