...
@section('content')
    ...
    <form action="" id="cadastro-baldeio" nome="cadastro-baldeio" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/baldeio/store">
        ...
        <div class="row">
            <div class="form-group col-md-3">
                Tipo do baldeio:
                <input class="form-control" type="text" name="baldeio" id="baldeio"  value="" >
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('button#sair').click(function(){
                $(location).attr('href',url+'/baldeio');
            })
