...
@section('content')
    ...
    <form action="" id="cadastro-arrasto" nome="cadastro-arrasto" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/arrasto/store">
        ...
        <div class="row">
            <div class="form-group col-md-3">
                Tipo do Arrasto:
                <input class="form-control" type="text" name="arrasto" id="arrasto"  value="" >
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('button#sair').click(function(){
                $(location).attr('href',url+'/arrasto');
            })
