...
@section('content')
    ...
    <form action="" id="cadastro-comprimento_madeira" nome="cadastro-comprimento_madeira" method="post">
        @csrf
        @method('patch')
        <input type="hidden" name="route" id="route" value="/comprimento_madeira/store">
        ...
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <input class="form-control" type="number" step="any" name="comprimento" id="comprimento"  value="" >
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-3">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('button#sair').click(function(){
                $(location).attr('href',url+'/comprimento_madeira');
            })
